...
export default {
  ...
  activate: function () {
    ...
    this.subscriptions.add(atom.commands.add('atom-workspace', {
      'autocomplete-tyranoscript-paths:rebuild-cache': () => {
    ...
    const cacheOptions = [
      ...
      'autocomplete-tyranoscript-paths.ignoreSubmodules',
      'autocomplete-tyranoscript-paths.ignoredNames',
      'autocomplete-tyranoscript-paths.ignoredPatterns'
    ]
    ...
    const scopeOptions = ['autocomplete-tyranoscript-paths.scopes']
    for (let key in OptionScopes) {
      scopeOptions.push(`autocomplete-tyranoscript-paths.${key}`)
    }
  ...
  _displayStatusBarTile () {
    ...
    this._statusBarElement = document.createElement('autocomplete-tyranoscript-paths-status-bar')
